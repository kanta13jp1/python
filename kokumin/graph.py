...
times = ['2022年1月', '2022年2月', '2022年3月', '2022年4月', '2022年5月', '2022年6月', '2022年7月', '2022年8月', '2022年9月', '2022年10月', '2022年11月', '2022年12月',
         '2023年1月', '2023年2月', '2023年3月', '2023年4月']  # time periods (e.g. months or years)
support_ratings = [4, 4, 1, 1, 2, 3, 3, 4, 4, 4, 4, 5, 4, 4, 4, 4]  # 毎日新聞
support_ratings2 = [0.8, 1.3, 1.8, 0.6, 2.1, 2.6,
                    2.5, 3.0, 2.9, 2.6, 3.8, 3.2, 2.2, 3.1, 3.1, 3.1]  # 共同通信
support_ratings3 = [1.0, 1.0, 1.0, 1.5, 1.2, 1.3,
                    1.6, 1.5, 2.1, 1.1, 1.2, 1.5, 1.0, 1.3, 1.4, 1.3]  # NHK
support_ratings4 = [1, 1, 1, 2, 1, 1, 2, 2, 1, 2, 2, 1, 1, 2, 1, 1]  # 朝日新聞
support_ratings5 = [1.7, 1.9, 2.3, 1.5, 2.4, 1.9,
                    2.6, 2.4, 1.4, 2.0, 2.1, 2.8, 1.7, 1.9, 1.6, 2.0]  # ANN
support_ratings6 = [2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3, 2, 2]  # 日経・テレ東
support_ratings7 = [0.7, 1.0, 1.2, 1.5, 1.0, 0.6,
                    1.9, 1.3, 1.3, 1.1, 0.6, 1.4, 1.5, 0.8, 0.7, 0.8]  # 時事通信
support_ratings8 = [1.1, 1.6, 1.4, 2.2, 1.1, 1.4,
                    0.6, 1.7, 1.4, 2.6, 2.0, 0.8, 2.0, 1.8, 1.0, 1.1]  # TBS・JNN
support_ratings9 = [2, 1, 2, 1, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 2, 2]  # 読売・NNN
support_ratings10 = [1.3, 0.4, 0.7, 1.4, 1.5,
                     1.4, 2.0, 1.2, 1.3, 1.3, 1.8, 2.1, 1.7, 1.5, 1.4, 2.0]  # 産経・FNN
...
ax.plot(times, average_ratings, label="各社平均 2023/4/24 " + str(average) + "%")
